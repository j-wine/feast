...
try:
    ...
    BigQueryDataSourceCreator = None
...
try:
    ...
    RedshiftDataSourceCreator = None
...
try:
    ...
    SnowflakeDataSourceCreator = None
...
try:
    ...
    BigtableOnlineStoreCreator = None
...
try:
    ...
    DatastoreOnlineStoreCreator = None
...
try:
    ...
    DynamoDBOnlineStoreCreator = None
...
if os.getenv("FEAST_IS_LOCAL_TEST", "False") != "True":
    cloud_sources = []
    if BigQueryDataSourceCreator:
        cloud_sources.append(("gcp", BigQueryDataSourceCreator))
    if RedshiftDataSourceCreator:
        cloud_sources.append(("aws", RedshiftDataSourceCreator))
    if SnowflakeDataSourceCreator:
        cloud_sources.append(("aws", SnowflakeDataSourceCreator))
    AVAILABLE_OFFLINE_STORES.extend(cloud_sources)
